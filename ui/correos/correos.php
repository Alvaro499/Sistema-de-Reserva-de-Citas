		...
		<main id="principal">
			...
			<form id="formu" class="form_correos" enctype="multipart/form-data">
				...
				<div class="cont_btn">
					...
					<label for="file" id="label_file" class="btn_ct btn_correos lang" name="adjuntar" key="adjuntar archivos">Adjuntar Archivos
						<span id="file_name" tabindex="0" class="lang" key="ningun archivo">Ningún archivo seleccionado</span>
					</label>

					<input type="file" id="file" name="file[]" class="archivo" multiple="true">
