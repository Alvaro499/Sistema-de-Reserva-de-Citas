	...
	<div class="container">
		...
		<div id="cont_carga" class="container_load">
			<div class="load_father">
				...
				<p class="text lang" key="load rcc" tabindex="0">AL FINALIZAR LA CARGA REVISE LA SECCIÓN DE NOTIFICACIONES<span>...</span</p>
			</div>
		</div>
			...
			if(validacion()){
				...
				$.ajax({
					...
					success: function(data){
						...
						if(data==1){
							toastr.success("Enviando solicitud","Éxito",{positionClass: "toast-bottom-right", showDuration: "500"});
							function refresh(){
								...
								setTimeout(load_circle(),1000);
								setTimeout(function(){location.reload();},10000)
								
							}refresh();
						}else if(data==0){
							toastr.error("Fallo al enviar solicitud. Refresque la página","Error",{positionClass: "toast-bottom-right", showDuration: "400"});
						}else{
							toastr.error("Error desconocido. Refresque la página","Error",{positionClass: "toast-bottom-right", showDuration: "400"});
						}
