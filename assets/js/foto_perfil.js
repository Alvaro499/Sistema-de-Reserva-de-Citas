...
input.onchange = function() {
    ...
    if (archivo.type == "image/png" || archivo.type == "image/svg" || archivo.type == "image/jpg" || archivo.type == "image/jpeg") {
        ...
        if (archivo.size >= 250000000) {
            ...
            toastr.error("El tamaño del archivo excede los 25MB", "Error", { positionClass: "toast-bottom-right", showDuration: "400" });
            //$("#agregar_foto").val('');
            this.value = "";
        ...
        toastr.error("Formato de imagen no permitido", "Error", { positionClass: "toast-bottom-right", showDuration: "400" });
        //$("#agregar_foto").val('');
        this.value = "";
    }
