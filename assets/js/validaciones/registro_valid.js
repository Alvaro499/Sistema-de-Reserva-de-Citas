...
function validacion() {
    ...
    if (ced == null || ced == "" || !regex_tel.test(ced)) {
        ...
        document.getElementById("error_ced").style.display = "block";
        ...
        document.getElementById("error_ced").style.display = "none";
    ...
    if (ape_1 == null || ape_1 == "" || !regex_texto.test(ape_1)) {
        ...
        document.getElementById("error_ap1").style.display = "block";
        ...
        document.getElementById("error_ap1").style.display = "none";
    ...
    if (ape_2 == null || ape_2 == "" || !regex_texto.test(ape_2)) {
        ...
        document.getElementById("error_ap2").style.display = "block";
        ...
        document.getElementById("error_ap2").style.display = "none";
    ...
    if (cel_1 == null || cel_1 == "" || !regex_tel.test(cel_1)) {
       ...
       document.getElementById("error_num1").style.display = "block";
    ...
    if (regex_tel.test(cel_2)) {
        ...
        document.getElementById("error_num2").style.display = "block";
